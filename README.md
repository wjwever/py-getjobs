...
其实是项目[getjobs](https://github.com/loks666/get_jobs) 的python版本，不太熟悉Java，python开发起来就更顺手一些, 方便做一些个性化的二次开发。利用Deepseek把java转成了python，然后手工把代码调通，代码 AI味道比较重，但AI确实写的好啊，惭愧不如。
